[![CI Status](https://img.shields.io/github/actions/workflow/status/postgrespro/testgres.os_ops/.github/workflows/package-verification.yml?label=CI)](https://github.com/postgrespro/testgres.os_ops/actions/workflows/ci.yml)
